...
export class LiveFileService {
  ...
  private async readDiskText(filePath: string) {
    ...
    if (this.options.workspaceKind !== 'project') await assertGlobalFilesPathSafe(this.rootDir, fullPath)
  ...
  private async writeDiskText(session: LiveFileSession, content: string, revision: number) {
    ...
    if (this.options.workspaceKind !== 'project') await assertGlobalFilesPathSafe(this.rootDir, session.fullPath)
  ...
  async open(filePath: string) {
    if (this.options.workspaceKind !== 'project') await assertGlobalFilesPathSafe(this.rootDir, this.resolvePath(filePath))
